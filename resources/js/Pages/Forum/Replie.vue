    ...
    <div>
      ...
      <div v-if="conversation.lock_comment" class="bg-indigo-900 text-center py-4 lg:px-4 mb-4">
        <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
          ...
          <span class="font-semibold mr-2 text-left flex-auto">Can't comment or reply because the post owner has locked
            this feature</span>
        </div>
      </div>
            ...
            <div class="relative flex-1">
              <header class="mb-4 flex items-center justify-between">
                ...
                <div v-if="replie.best_answer == 1" class="relative ml-3 flex" style="top: -5px;">
                  <span
                    class="inline-flex items-center rounded-full bg-blue-500 px-3 py-1 text-2xs font-bold uppercase text-white md:text-2xs">Best
                    Answer</span>
                </div>
              </header>
            ...
            <div class="flex px-6 py-4 lg:p-5">
              ...
              <div class="relative flex-1">
                <header class="mb-4 flex items-center justify-between">
                  ...
                  <div v-if="re_reply.best_answer == 1" class="relative ml-3 flex" style="top: -5px;">
                    <span
                      class="inline-flex items-center rounded-full bg-blue-500 px-3 py-1 text-2xs font-bold uppercase text-white md:text-2xs">Best
                      Answer</span>
                  </div>
      ...
      <UpdateReplieComponent v-if="conversation.lock_comment == false" :conversation="conversation"
        :initalReplies="initalReplies"></UpdateReplieComponent>
    </div>
...
export default {
  ...
  methods: {
    ...
    listenForLockComment() {
      ...
      //   }
      // });
      window.Echo.channel("sovled-conversation").listen("SovledConversationEvent", e => {
