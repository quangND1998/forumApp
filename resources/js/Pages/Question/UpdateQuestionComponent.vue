<template>
  <div>
    <div class="md:grid md:gap-6">
      <h1 class="dark:text-white">Update conversation</h1>
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
              ...
              <div>
                ...
                <div class="mt-1">
                  <!-- <textarea id="about" name="about" v-model="form.body" rows="3"
                                        ...
                                        class="shadow-sm focus:ring-indigo-500 h-48 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
              ...
              <div class="md:grid md:grid-cols-2 md:gap-2">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-4 gap-4">
                    <div v-for="(video,index) in conversation.videos" :key="index">
...
export default {
  ...
  methods: {
    submit() {
      this.form.post(
        this.route("admin.conversation.update", this.conversation.id),
        {
          preserveState: true,
          onError: errors => {
    ...
    deleteImage(id) {
      ...
      axios
        ...
        .then(response => {
          this.conversation.images.splice(
            this.conversation.images.indexOf(id),
            1
          );
          setTimeout(() => {
    ...
    deleteVideo(id) {
      ...
      axios
        ...
        .then(response => {
          this.conversation.videos.splice(
            this.conversation.videos.indexOf(id),
            1
          );
          setTimeout(() => {
            this.$toast.success(response.data, {
