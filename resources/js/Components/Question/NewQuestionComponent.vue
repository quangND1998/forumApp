    ...
    <div>
        <transition name="fade">
            ...
            >
                ...
                <div
                    class="modal-container overflow-x-auto bg-white w-full h-screen sm:h-auto sm:w-10/12 md:max-w-xl mx-auto shadow-2xl"
                    style="z-index:9999;"
                >
                    ...
                    <div class="modal-content p-2 px-4 text-left">
                        ...
                        <div>
                            ...
                            <div class="pt-4">
                                <label for="category" class="py-2">Select_category</label>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            //         self.closeModal()
            //         this.$router.push({
            //             name: 'chatter.discussion', params: {
