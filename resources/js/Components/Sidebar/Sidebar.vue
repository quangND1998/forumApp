  ...
  <nav
    ...
    <div
      ...
      <div
        ...
        <li class="inline-flex" v-if="hasAnyPermission(['Admin'])">
            <Link :class="[$page.url == '/admin/conversations' ? 'opacity-75 text-blue-300  dark:text-blue-500' : '']"
              :href="route('admin.conversations')" 
              class="text-blueGray-700 dark:text-gray-100 hover:text-blueGray-400 text-sm block mb-4 no-underline font-semibold">
            <i class="fas fa-paint-brush mr-2  text-blueGray-300  dark:text-gray-100 text-base" :class="[$page.url == '/admin/conversations' ? 'opacity-75 text-blue-300  dark:text-blue-500' : '']" ></i>
