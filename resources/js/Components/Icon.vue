<template>
  ...
  <svg v-else-if="name === 'tour'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
  </svg>
  <svg v-else-if="name === 'scan'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path d="M18 12H6" />
  </svg>
  <svg v-else-if="name === 'dropdown'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" />
  </svg>

  <svg v-else-if="name === 'logout'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
    stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
  </svg>
  <svg v-else-if="name === 'history_account'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" />
  </svg>
  <svg v-else-if="name === 'customer'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
  ...
  <svg v-else-if="name === 'de'" enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512"
    xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  <svg v-else-if="name === 'vn'" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
  ...
  <svg v-else-if="name === 'mail'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
  </svg>
  <svg v-else-if="name === 'tag'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path fill-rule="evenodd"
      d="M9.243 3.03a1 1 0 01.727 1.213L9.53 6h2.94l.56-2.243a1 1 0 111.94.486L14.53 6H17a1 1 0 110 2h-2.97l-1 4H15a1 1 0 110 2h-2.47l-.56 2.242a1 1 0 11-1.94-.485L10.47 14H7.53l-.56 2.242a1 1 0 11-1.94-.485L5.47 14H3a1 1 0 110-2h2.97l1-4H5a1 1 0 110-2h2.47l.56-2.243a1 1 0 011.213-.727zM9.03 8l-1 4h2.938l1-4H9.031z"
      clip-rule="evenodd" />
  </svg>
  <svg v-else-if="name === 'cateory'" id="outline" height="512" viewBox="0 0 512 512" width="512"
    ...
    <path d="m280 296h24v16h-24z" />
    <path d="m320 296h112v16h-112z" />
    <path
    ...
    <path d="m280 360h24v16h-24z" />
    <path d="m320 360h112v16h-112z" />
    <path
    ...
    <path d="m280 424h24v16h-24z" />
    <path d="m320 424h112v16h-112z" />
    <path
  ...
  <svg v-else-if="name === 'videos'" height="512pt" viewBox="-31 0 512 512" width="512pt"
    xmlns="http://www.w3.org/2000/svg">
    <g fill-rule="evenodd">
      <path
  ...
  <svg v-else-if="name === 'borchure'" id="Capa_1" enable-background="new 0 0 512 512" height="512"
  ...
  <svg v-else-if="name === 'language'" id="Capa_1" enable-background="new 0 0 512 512" height="512"
    viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
    <g>
      <path
        d="m207.386 280.048c0-4.142-3.358-7.5-7.5-7.5h-168.338c-9.125 0-16.548-7.423-16.548-16.548v-224.452c0-9.125 7.423-16.548 16.548-16.548h224.452c9.125 0 16.548 7.423 16.548 16.548v168.338c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-168.338c0-17.396-14.152-31.548-31.548-31.548h-224.452c-17.396 0-31.548 14.152-31.548 31.548v224.452c0 17.396 14.152 31.548 31.548 31.548h168.338c4.142 0 7.5-3.358 7.5-7.5z" />
      <path
  ...
  <svg v-else-if="name === 'project'" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512"
  ...
  <svg v-else-if="name === 'virtual'" id="Icons" height="512" viewBox="0 0 74 74" width="512"
    xmlns="http://www.w3.org/2000/svg">
    <path
    ...
    <path d="m45.68 15.5h-2.97a1 1 0 0 1 0-2h2.97a1 1 0 0 1 0 2z" />
    <path
      d="m9 50.5a1 1 0 0 1 -1-1v-31a5.006 5.006 0 0 1 5-5h12.81a1 1 0 1 1 0 2h-12.81a3 3 0 0 0 -3 3v31a1 1 0 0 1 -1 1z" />
    <path d="m35.71 15.5h-2.9a1 1 0 0 1 0-2h2.9a1 1 0 0 1 0 2z" />
    <path
  ...
  <svg v-else-if="name === 'sample'" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512"
    width="512" xmlns="http://www.w3.org/2000/svg">
    <g>
      <path
      ...
      <path d="m111.236 277.451c0 5.358 2.858 10.307 7.497 12.986l122.361 70.645v-149.012l-129.859-74.974v140.355z" />
      <path d="m400.942 277.451v-140.726l-129.858 75.325v149.032l122.361-70.645c4.64-2.679 7.497-7.628 7.497-12.986z" />
    </g>
  </svg>
  <svg v-else-if="name === 'analytic'" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
  </svg>
  <svg v-else-if="name === 'license'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
    stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
  </svg>

  <svg v-else-if="name === 'vr'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path fill-rule="evenodd"
  ...
  <svg v-else-if="name === 'zoom'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
  </svg>

  <svg v-else-if="name === 'landingpage'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path fill-rule="evenodd"
  ...
  <svg v-else-if="name === 'template'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path
      d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
  </svg>
  <svg v-else-if="name === 'arrow'" class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400"
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path
      d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" />
  </svg>
  <svg v-else-if="name === 'home'" class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path
      d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
  </svg>
  <svg v-else-if="name === 'news'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path fill-rule="evenodd"
      d="M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3 1h6v4H5V6zm6 6H5v2h6v-2z"
      clip-rule="evenodd" />
  ...
  <svg v-else-if="name === 'infor'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
    fill="currentColor">
    <path fill-rule="evenodd"
      d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
      clip-rule="evenodd" />
  </svg>
  <svg v-else-if="name === 'setting'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
    stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
  <svg v-else-if="name === 'profile'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
    stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round"
      d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
  </svg>

  <svg v-else-if="name === 'question'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round"
      d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>

  <svg v-else-if="name === 'plus'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
    stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
  </svg>

  <svg v-else-if="name === 'battery-medium'" xml:space="preserve" viewBox="0 0 100 100" y="0" x="0"
    xmlns="http://www.w3.org/2000/svg" id="圖層_1" version="1.1" width="199px" height="199px"
    xmlns:xlink="http://www.w3.org/1999/xlink"
    style="background-size:initial;background-repeat-y:initial;background-repeat-x:initial;background-position-y:initial;background-position-x:initial;background-origin:initial;background-image:initial;background-color:rgb(255, 255, 255);background-clip:initial;background-attachment:initial;animation-play-state:paused">
    <g class="ldl-scale"
      style="transform-origin:50% 50%;transform:rotate(0deg) scale(1, 1);animation-play-state:paused">
      <path fill="#e0e0e0"
        d="M87.5 42.1h-7.9V31.3c0-.6-.5-1.1-1.1-1.1h-66c-.6 0-1.2.5-1.2 1.2v37.5c0 .6.5 1.2 1.2 1.2h66c.6 0 1.1-.5 1.1-1.1V57.9h7.9c.6 0 1.1-.5 1.1-1.1V43.2c.1-.6-.4-1.1-1.1-1.1z"
        style="fill:rgb(224, 224, 224);animation-play-state:paused"></path>
      <path fill="#333"
        d="M87.5 38.3h-4.1v-7c0-2.7-2.2-5-5-5h-66c-2.7 0-5 2.2-5 5v37.5c0 2.7 2.2 5 5 5h66c2.7 0 5-2.2 5-5v-7h4.1c2.7 0 5-2.2 5-5V43.2c0-2.7-2.2-4.9-5-4.9zm1.2 18.5c0 .6-.5 1.1-1.1 1.1h-7.9v10.8c0 .6-.5 1.1-1.1 1.1h-66c-.6 0-1.2-.5-1.2-1.2V31.3c0-.6.5-1.2 1.2-1.2h66c.6 0 1.1.5 1.1 1.1V42h7.9c.6 0 1.1.5 1.1 1.1v13.7z"
        style="fill:rgb(51, 51, 51);animation-play-state:paused"></path>
      <path d="M14.4 33.2h15.5v33.2H14.4z" fill="#f8b26a" style="fill:rgb(233, 145, 55);animation-play-state:paused">
      </path>
      <path d="M30 33.2h15.5v33.2H30z" fill="#f8b26a" style="fill:rgb(233, 145, 55);animation-play-state:paused"></path>
      <metadata xmlns:d="https://loading.io/stock/" style="animation-play-state:paused">
        <d:name style="animation-play-state:paused">battery</d:name>
        <d:tags style="animation-play-state:paused">charge,energy,power,electricity,progress,battery,web application
        </d:tags>
        <d:license style="animation-play-state:paused">pro</d:license>
        <d:slug style="animation-play-state:paused">fs42h4</d:slug>
      </metadata>
    </g><!-- generated by https://loading.io/ -->
  </svg>

  <svg v-else-if="name === 'battery-low'" xml:space="preserve" viewBox="0 0 100 100" y="0" x="0"
    ...
    <g class="ldl-scale"
      style="transform-origin:50% 50%;transform:rotate(0deg) scale(1, 1);animation-play-state:paused">
      <path fill="#e0e0e0"
        d="M76.625 32.5h-62.25a.125.125 0 0 0-.125.125v34.75c0 .069.056.125.125.125h62.25a.125.125 0 0 0 .125-.125v-34.75a.125.125 0 0 0-.125-.125z"
        style="fill:rgb(224, 224, 224);animation-play-state:paused"></path>
      <path d="M18.25 36.5v27h13.616l-8.403-27z" fill="#e15b64"
      ...
      <metadata xmlns:d="https://loading.io/stock/" style="animation-play-state:paused">
        <d:name style="animation-play-state:paused">battery</d:name>
        <d:tags style="animation-play-state:paused">charge,energy,low power,drain,off,empty,electricity,battery,camera
        </d:tags>
        <d:license style="animation-play-state:paused">by</d:license>
        <d:slug style="animation-play-state:paused">odhs4s</d:slug>
      </metadata>
    </g><!-- generated by https://loading.io/ -->
  </svg>

  <svg v-else-if="name === 'battery-full'" xml:space="preserve" viewBox="0 0 100 100" y="0" x="0"
    xmlns="http://www.w3.org/2000/svg" id="圖層_1" version="1.1" width="200px" height="200px"
    xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g class="ldl-scale"
      ...
      <path fill="#333"
        d="M87.5 38.3h-4.1v-7c0-2.7-2.2-5-5-5h-66c-2.7 0-5 2.2-5 5v37.5c0 2.7 2.2 5 5 5h66c2.7 0 5-2.2 5-5v-7h4.1c2.7 0 5-2.2 5-5V43.2c0-2.7-2.2-4.9-5-4.9zm1.2 18.5c0 .6-.5 1.1-1.1 1.1h-7.9v10.8c0 .6-.5 1.1-1.1 1.1h-66c-.6 0-1.2-.5-1.2-1.2V31.3c0-.6.5-1.2 1.2-1.2h66c.6 0 1.1.5 1.1 1.1V42h7.9c.6 0 1.1.5 1.1 1.1v13.7z"
        style="fill:rgb(51, 51, 51);animation-play-state:paused"></path>
      <path d="M45.5 33.2h15.3v33.2H45.5z" fill="#849b87" style="fill:rgb(13, 188, 36);animation-play-state:paused">
      </path>
      <path d="M60.7 33.2H76v33.2H60.7z" fill="#849b87" style="fill:rgb(13, 188, 36);animation-play-state:paused">
      </path>
      <path d="M14.4 33.2h15.5v33.2H14.4z" fill="#849b87" style="fill:rgb(13, 188, 36);animation-play-state:paused">
      </path>
      <path d="M30 33.2h15.5v33.2H30z" fill="#849b87" style="fill:rgb(13, 188, 36);animation-play-state:paused"></path>
      <metadata xmlns:d="https://loading.io/stock/" style="animation-play-state:paused">
        <d:name style="animation-play-state:paused">battery</d:name>
        <d:tags style="animation-play-state:paused">charge,energy,full,power,electricity,progress,battery,web
          application</d:tags>
        <d:license style="animation-play-state:paused">pro</d:license>
        <d:slug style="animation-play-state:paused">fuluck</d:slug>
      </metadata>
    </g><!-- generated by https://loading.io/ -->
  </svg>
  <svg v-else-if="name=='popular'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
